...
gens.team 采用系统化、自动化的开发规范体系，确保代码质量、团队协作效率和项目长期可维护性。
...
gens.team 是一个 **Monorepo** 项目，包含三个主要服务：
...
- **Issues：** [GitHub Issues](https://github.com/genesis-agents/gens-team/issues)
