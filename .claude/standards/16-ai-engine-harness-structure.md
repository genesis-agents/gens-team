...
| **teams**      | gens.team 团队业务模式                           | abstractions / base / profile / factory / registry / orchestrator / services / **collaboration** |
...
.agent.ts            Agent 实现类
.skill.ts            Skill 实现类
.stage.ts            Pipeline 阶段（gens.team 特有）
```
...
gens.team 选词：取业界共识的最常见词，且每个名字单一概念，杜绝同名歧义。
